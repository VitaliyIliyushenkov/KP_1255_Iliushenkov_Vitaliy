...
namespace TEST
{
    public partial class Form1 : Form
    {
        ...
        TestResult CreateResult()
        {
            ...
            // заполнение данными
            newResult.name = name_box.Text;
            newResult.surname = surname_box.Text;
            newResult.age = (int)age_up_down.Value;
            newResult.group = group_combo_box.Text;
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            Error = "Заполните все поля";
            {
                if (Debag() == false)
                {
                    DialogResult dialogResult = MessageBox.Show(Error, "Предупреждение",
